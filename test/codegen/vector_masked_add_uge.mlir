module {
  func.func @masked_add_uge(%arg0: memref<?xi32>, %arg1: memref<?xi32>, %arg2: memref<?xi32>, %arg3: memref<?xi32>, %arg4: memref<?xi32>, %arg5: memref<?xi32>, %arg6: i32) -> i32 {
    ...
    scf.for %arg7 = %c0 to %0 step %c4 {
      ...
      %6 = arith.cmpi uge, %4, %5 : vector<4xi32>
