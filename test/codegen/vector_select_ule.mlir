module {
  func.func @select_ule(%arg0: memref<?xi32>, %arg1: memref<?xi32>, %arg2: memref<?xi32>, %arg3: memref<?xi32>, %arg4: memref<?xi32>, %arg5: i32) -> i32 {
    ...
    scf.for %arg6 = %c0 to %0 step %c4 {
      ...
      %8 = arith.cmpi ule, %4, %5 : vector<4xi32>
